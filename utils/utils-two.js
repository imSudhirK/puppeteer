...
async function convertHtmlToPdfV02(html, styleTag, options = {}) {
    ...
    await page.addStyleTag({ content: styleTag || '@media print { body { background-color: white; } }' });
...
module.exports = { convertHtmlToPdfV00, convertHtmlToPdfV01, convertHtmlToPdfV02 }